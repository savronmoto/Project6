...
; Receives:	[EBP+28] = MAXSIZE - input parameter by value
;			[EBP+24] = validInt - output by reference - offset address for data label
;			[EBP+20] = invalid - input by reference - offset address for string
;           [EBP+16] = sLen - input by reference - offset address
;			[EBP+12] = inString (the buffer) - output by reference
;	    	[EBP+8] = prompt - input by reference - offset address for string
...
_getInput:
  mGetString [EBP+8],[EBP+12],[EBP+28],[EBP+16]
